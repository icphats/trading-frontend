          ...
          {#if isMobileMenuOpen}
            <div class="mobile-menu-dropdown">
              ...
              <div class="mobile-social-links">
                <a href="https://x.com/PartyhatsICP" target="_blank" rel="noopener noreferrer" class="social-link x" aria-label="X" onclick={closeMobileMenu}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                  </svg>
                </a>
                <a href="https://discord.gg/3Gvm4JPkxS" target="_blank" rel="noopener noreferrer" class="social-link discord" aria-label="Discord" onclick={closeMobileMenu}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="https://t.me/partyhatsICP" target="_blank" rel="noopener noreferrer" class="social-link telegram" aria-label="Telegram" onclick={closeMobileMenu}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
...
<style>
  ...
  :global(.dark) .social-link.x:hover { color: #fff; }
  .social-link.discord:hover { color: #5865F2; }
  .social-link.telegram:hover { color: #26A5E4; }
